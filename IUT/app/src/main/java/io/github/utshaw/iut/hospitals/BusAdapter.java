...
public class BusAdapter extends ArrayAdapter<Bus> {
    ...
    public BusAdapter(Activity context, ArrayList<Bus> quakeArrayList)
    {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        hospitalLocation.setText(currentBus.getVicinity());

        TextView hospitalName = (TextView)listItemView.findViewById(R.id.list_name);
        hospitalName.setText(currentBus.getmName());
        ...
        double distanceFromUser = currentBus.getDistanceFromCurrentLocation()/1000;
